...
VALUES
    ...
    ('good news', 'bazinga haha', false, NOW() - interval '2 days 5 hours', NOW() - interval '2 days hours'),
    ('bad news', 'kidding, nothing happened', false, NOW() - interval '5 hours', NOW() - interval '5 hours');
